...
class JPositiveOp extends JUnaryExpression {
     ...
     * the operand, and then the positive instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
...
class JComplementOp extends JUnaryExpression {
    ...
    /**
     * Construct an AST node for a complement given its line number, and the
     * operand.
     * 
     * @param line
     *            line in which the expression occurs in the source file.
